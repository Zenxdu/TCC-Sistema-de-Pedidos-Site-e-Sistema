...
if ($_SESSION['customer_sid'] == session_id()) {
    $user_id = $_SESSION['user_id']; // Obtendo o user_id da sessão
    $continue = 1;
}
...
// Inicializando variáveis de endereço
$rua = '';
$bairro = '';
$numero = '';
$complemento = '';
...
// Verificando se as chaves existem no array $_POST
if (isset($_POST['rua'])) {
    $rua = $_POST['rua'];
}
...
// Inserir o endereço na tabela enderecodeentrega se todos os campos de endereço estiverem preenchidos
if ($rua && $bairro && $numero) {
    ...
    if (!mysqli_query($con, $sql)) {
        echo "Erro ao salvar o endereço: " . mysqli_error($con);
    }
}

// Continuando se o usuário estiver logado
if ($continue) {
?>
...
<head>
    ...
    <title>Forneça os Detalhes do Pedido</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title">Forneça os Detalhes do Pedido</h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <div>
                    <ul id="issues-collection" class="collection">
                        ...
                        echo '<li class="collection-item avatar">
                                ...
                                <p><strong>Endereço:</strong> ' . $rua . ', ' . $bairro . ', ' . $numero . '</p>';
                        if ($complemento) {
                            echo '<p><strong>Complemento:</strong> ' . $complemento . '</p>';
                        }
                        echo '<p><strong>Forma de Pagamento:</strong> ' . $payment_type . '</p>';
                        ...
                        foreach ($_POST as $key => $value) {
                            ...
                            if (is_numeric($key)) {
                                ...
                                echo '<li class="collection-item">
                                        <div class="row">
                                            <div class="col s7">
                                                <p class="collections-title"><strong>#' . $ingredient_id . ' </strong>' . $ingredient_name . '</p>
                                            </div>
                                            <div class="col s2">
                        ...
                        if (!empty($description))
                            echo '<li class="collection-item avatar"><p><strong>Nota: </strong>' . htmlspecialchars($description) . '</p></li>';
                        ?>
                        <form action="routers/custom-router.php" method="post">
                            <?php
                            foreach ($_POST as $key => $value) {
                                if (is_numeric($key)) {
                            ...
                            <div class="input-field col s12">
                                <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Confirmar Pedido
