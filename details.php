  ...
  <div id="main">
    ...
    <div class="wrapper">
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>Pedidos</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="orders.php">Todos Pedidos</a>
                                </li>
								<?php
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Detalhes do Usuário</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Edite seus detalhes aqui que são necessários para entrega e contato.</p>
...
<div>
                    ...
                    <form class="formValidate" id="formValidate" method="post" action="routers/details-router.php" novalidate="novalidate" class="col s12">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <label for="phone" class="">Contato</label>
  ...
  <footer class="page-footer">
    ...
    username: {
        ...
        minlength: "São necessários no mínimo 5 caracteres.",
        maxlength: "São necessários no máximo 20 caracteres."
    },
    name: {
        required: "Digite o nome",
        minlength: "São necessários no mínimo 5 caracteres.",
        maxlength: "São necessários no máximo 30 caracteres."
    },
    email: {
        required: "Digite o email",
        maxlength: "São necessários no máximo 50 caracteres."
    },
    password: {
    ...
    phone: {
        required: "Especifique o número de contato.",
        minlength: "São necessários no mínimo 4 caracteres.",
        maxlength: "São aceitos no máximo 15 dígitos."
    },
    address: {
        required: "Especifique o endereço",
        minlength: "São necessários no mínimo 10 caracteres.",
        maxlength: "São aceitos no máximo 40 caracteres."
    },			
        },
        errorElement : 'div',
