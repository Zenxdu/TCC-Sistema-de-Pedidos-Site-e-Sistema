...
<head>
  ...
  <title>Menu de Ingredientes</title>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
          ...
          <li class="bold"><a href="admin-page.php" class="waves-effect waves-cyan"><i class="mdi-action-add-shopping-cart"></i> Menu de comida</a></li>
          <li class="bold active" active><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i>Menu de Customizados</a></li>
          <li class="no-padding">
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Menu de Ingredientes</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!-- Início do container -->
        <div class="container">
          <p class="caption">Adicionar, Editar ou Remover Ingredientes do Menu.</p>
          <div class="divider"></div>
          <form class="formValidate" id="formValidate" method="post" action="routers/ingredient-router.php" novalidate="novalidate" enctype="multipart/form-data">
            <div class="row">
              ...
              <div>
                <table id="data-table-admin" class="responsive-table display" cellspacing="0">
                  ...
                  <tbody>
                    <?php
                    // Recupera todos os ingredientes do banco de dados
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      <td>
                        <form action="routers/delete-ingredient.php" method="post" onsubmit="return confirm(\'Tem certeza que deseja excluir este ingrediente?\');">
              ...
              <div class="input-field col s12">
                <a class="btn cyan waves-effect waves-light left"  href="add-ingredient-page.php">Adicionar Ingrediente
