  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <!-- Início do container -->
        <div class="container">
          <p class="caption">Adicionar Ingredientes no Menu.</p>
          <div class="divider"></div>
          <form class="formValidate" id="formValidate1" method="post" action="routers/add-ingredient.php" novalidate="novalidate" enctype="multipart/form-data">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Adicionar Ingrediente</h4>
              </div>
              <div class="col s12">
